...
import io.vitaliivorobii.redis.netty.bridge.redis.insight.client.http.StringValueFetcherImpl;
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        HttpDatabaseIdProvider databaseIdProvider = new HttpDatabaseIdProvider(httpClient, redisInsightBaseURI);
